...
<nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  ...
  <a href="https://www.viator.com/" className="flex items-center">
      <img src={viator} className="h-6 mr-3 sm:h-9" alt="viator logo"/>
  </a>
  <span className="box-decoration-clone bg-gradient-to-r from-indigo-600 to-pink-500 text-white px-2 ... font-sans hover:text-5xl text-2xl">
